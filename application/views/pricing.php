          ...
          <div class="col-12 col-md-10 d-none d-lg-block">
            <nav class="site-navigation position-relative text-right" role="navigation">
              ...
              <ul class="site-menu main-menu js-clone-nav mr-auto d-none d-lg-block">
                ...
                <li><a href="<?php echo site_url() ?>" class="nav-link">Features</a></li>
                <li class="active"><a href="<?php echo site_url() ?>" class="nav-link">Pricing</a></li>
                
                <li class="has-children">
                  <a href="<?php echo site_url() ?>" class="nav-link">Blog</a>
                  <ul class="dropdown">
                    <li><a href="<?php echo site_url() ?>" class="nav-link">Blog</a></li>
                    <li><a href="<?php echo site_url() ?>" class="nav-link">Blog Sigle</a></li>
                  </ul>
                </li>
                <li><a href="<?php echo site_url() ?>" class="nav-link">Contact</a></li>
              </ul>
            </nav>
          </div>
